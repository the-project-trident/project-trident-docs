...
**Implementation:** Angular **17** + Material **17** ([ADR-005](../08-decisions/ADR-005-angular-frontend-choice.md), [Design System](07-design-system.md), [Implementation Plan](08-frontend-implementation-plan.md)).
